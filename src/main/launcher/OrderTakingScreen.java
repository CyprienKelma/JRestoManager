...
public class OrderTakingScreen {
    ...
    public static void redirectToApropriateAction(Scanner menuScanner, TransactionState actualTableState, Serveur whichWaiter, Transaction selectedTransaction){
